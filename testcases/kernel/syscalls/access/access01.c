...
static void setup(void)
{
	...
	SAFE_MKDIR(DNAME_R, 0744);
	SAFE_MKDIR(DNAME_W, 0722);
	SAFE_MKDIR(DNAME_X, 0711);
	SAFE_MKDIR(DNAME_RW, 0766);
	SAFE_MKDIR(DNAME_RX, 0755);
	...
	SAFE_CHMOD(DNAME_R, 0444);
	SAFE_CHMOD(DNAME_W, 0222);
	SAFE_CHMOD(DNAME_X, 0111);
	SAFE_CHMOD(DNAME_RW, 0666);
	SAFE_CHMOD(DNAME_RX, 0555);
}
